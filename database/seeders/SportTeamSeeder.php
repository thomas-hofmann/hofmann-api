...
class SportTeamSeeder extends Seeder
{
    ...
    {
        $sportTeams = [
            ['name' => 'FC Bayern München', 'sport' => 'Fußball', 'league' => 'Bundesliga', 'city' => 'München', 'founded_year' => 1900],
            ['name' => 'Borussia Dortmund', 'sport' => 'Fußball', 'league' => 'Bundesliga', 'city' => 'Dortmund', 'founded_year' => 1909],
